...
class _CategorySliderState extends State<CategorySlider>
  ...
  static const double _listSeparatorCompact = 4;
  static const int _visibleSlots = 5;
  /// Below this width, drop side chevrons so four categories use full row width.
  static const double _compactNavBreakpoint = 560;
  ...
  Widget build(BuildContext context) {
    ...
    final showSideChevrons = screenW >= _compactNavBreakpoint;
    final sep =
        showSideChevrons ? _listSeparator : _listSeparatorCompact;
            ...
            Expanded(
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final itemWidth =
                      (listW - (_visibleSlots - 1) * sep) / _visibleSlots;
                  _scrollStep = itemWidth + sep;
                  ...
                  return SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      separatorBuilder: (_, __) => SizedBox(width: sep),
